    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 flex flex-col gap-6 border-2 border-pink-100">
          <h1 className="text-3xl font-extrabold text-center mb-2" style={{ color: PRIMARY }}>Sign Up</h1>
          ...
          <div className="text-center mt-2 text-base text-pink-300">
            ...
            <a href="/signin" className="font-bold hover:underline" style={{ color: '#F610C1' }}>Sign In</a>
          </div>
        </div>
      </main>
      <Footer
